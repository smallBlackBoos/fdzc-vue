...
// 左侧菜单栏数据
const menu = ref([
  { path: "/discipline_con/dc/1", meta: "本科培养" },
  { path: "/discipline_con/dc/2", meta: "专升本培养" },
  { path: "/discipline_con/dc/3", meta: "实践教学" },
  { path: "/discipline_con/dc/4", meta: "质量工程" },
  { path: "/discipline_con/dc/5", meta: "教学成果奖" },
]);
