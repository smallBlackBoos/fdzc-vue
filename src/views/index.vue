...
<!--        header-line-->
                    ...
                    <el-col :span="24">
                        ...
                        >
                            ...
                            <el-sub-menu index="/discipline_con">
                                ...
                                <el-menu-item index="/discipline_con/dc/details/16" exact>教学成果奖</el-menu-item>
                            </el-sub-menu>
                            <el-sub-menu index="6">
        ...
        <el-footer class="footer">
            ...
            <el-row>
                <!-- 第一列 -->
                <el-col>
                    <button class="custom-button light" @click="goToWebsite('https://www.fdzcxy.edu.cn/')" >学院官网</button>
                    <button style="margin: 15px" class="custom-button light" @click="goToWebsite('https://zsb.fdzcxy.edu.cn/')">招生办</button>
                </el-col>
                <!-- 第二列 -->
                <el-col>
            ...
            <el-row>
                <el-col>
                    <img src="../assets/ygzh.jpg" alt="" style="height: 100px;margin-bottom: 10px">
                </el-col>
                <el-col>
                    院微信公众号
                </el-col>
        ...
        <!-- 返回顶部的按钮 -->
        <el-button v-show="showBackToTop" @click="scrollToTop" class="back-to-top" type="primary">
            返回顶部
        </el-button>
    </el-container>
</template>
